...
export const metadata: Metadata = {
  ...
  description: "Privacy policy, terms of use, and legal information for Vibe Themes",
};
        ...
        <div className="max-w-3xl space-y-12">
          ...
          <section id="privacy">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                Vibe Themes is designed with privacy in mind. We do not:
              </p>
          ...
          <section id="cookies">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                Vibe Themes does not use any cookies, tracking pixels, or similar technologies. 
          ...
          <section id="terms">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                By using Vibe Themes, you agree to the following terms:
              </p>
              
              <h3 className="text-lg font-semibold text-foreground mt-6">Use at Your Own Risk</h3>
              <p>
                Vibe Themes is provided &ldquo;as is&rdquo; without warranty of any kind, express or implied. 
              ...
              <p>
                ...
                materials provided through Vibe Themes. The generated design tokens are 
              ...
              <p>
                In no event shall Andrew Flett or Vibe Themes be liable for any direct, 
              ...
              <p>
                The design tokens and code generated by Vibe Themes are provided free of 
