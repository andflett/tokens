          ...
          <div className="rounded-xl border p-6 bg-card mb-6">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <CheckIcon className="h-4 w-4 mt-0.5 text-emerald-500" />
                <span>
                  <strong>Theming:</strong> Easily switch between light and dark
                  modes
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckIcon className="h-4 w-4 mt-0.5 text-emerald-500" />
                <span>
                  <strong>Communication:</strong> Designers and developers speak
                  the same language
                </span>
              </li>
            </ul>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                ...
                spaces better UI backgrounds and text contrast.
              </p>
              <Button intent="default" asChild>
