        ...
        <div className="space-y-12">
          ...
          <section id="design-tokens">
            ...
            <p className="text-muted-foreground mb-4">
              <Term term="design-tokens">Design tokens</Term> are the smallest building blocks of your
              design system. Instead of using raw values like{" "}
              <code className="px-1 py-0.5 rounded bg-muted text-sm">#3b82f6</code>,
              you use named tokens like{" "}
              <code className="px-1 py-0.5 rounded bg-muted text-sm">primary-500</code>.
            </p>
            ...
            <div className="rounded-xl border p-6 bg-card mb-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Consistency:</strong> Every component uses the same colors</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckIcon className="h-4 w-4 mt-0.5 text-emerald-500" />
                  <span><strong>Maintainability:</strong> Change one token, update everywhere</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckIcon className="h-4 w-4 mt-0.5 text-emerald-500" />
                  <span><strong>Theming:</strong> Easily switch between light and dark modes</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckIcon className="h-4 w-4 mt-0.5 text-emerald-500" />
                  <span><strong>Communication:</strong> Designers and developers speak the same language</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              <div className="rounded-xl border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  <Term term="color-scale">Color scales</Term> from 10 (lightest) to 100 (darkest)
                  for each brand color. These are the raw colors you&apos;ll reference.
                </p>
              </div>
              ...
              <div className="rounded-xl border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  <Term term="semantic-colors">Semantic colors</Term> named by purpose: primary,
                  secondary, success, warning, danger. These adapt to light/dark mode.
                </p>
              </div>
    ...
    "url": "https://vibethemes.flett.cc/mcp"
          ...
          <section id="tools">
            ...
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle className="font-mono text-lg">generate_tokens</CardTitle>
                </CardHeader>
                <CardContent>
...
- mode: "light" | "dark" | "both"`}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="font-mono text-lg">analyze_vibe</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
...
- vibeDescription: "calm and professional" or "bold and energetic"`}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="font-mono text-lg">export_tokens</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
...
- mode: "light" | "dark" | "both"`}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="font-mono text-lg">generate_component</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-3">
                    Generate a prompt for creating a <Term term="shadcn">shadcn/ui</Term> component
                    using your tokens.
                  </p>
                  <div className="rounded-lg bg-muted p-3">
                    <pre className="text-xs font-mono">
