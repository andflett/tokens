              ...
              <div className="space-y-4">
                <div className="rounded-md border bg-card overflow-hidden shadow-lg">
                  ...
                  <div className="flex items-center justify-between px-4 py-2.5 bg-muted/30 border-b">
                    ...
                    <CopyButton text="Generate a complete design token system for my fintech app with a deep blue primary color (#1e40af) and warm orange secondary (#f97316). Include all color scales, typography, spacing, and shadows. Export as Tailwind v4 CSS variables." />
                  </div>
